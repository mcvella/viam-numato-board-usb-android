...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        Registry.registerResourceCreator(Board.SUBTYPE, NumatoBoard.MODEL, new ResourceCreatorRegistration(NumatoBoard::new, NumatoBoard::validateConfig));
    ...
    public static class NumatoBoard extends Board {
        ...
        public NumatoBoard(Robot.ComponentConfig config, Map<Common.ResourceName, Resource> dependencies) {
        ...
        private boolean checkAndRequestPermission(UsbManager manager, UsbDevice usbDevice) {
            ...
            if (hasPermissions(cxt.getApplicationContext(), PERMISSIONS) && manager.hasPermission(usbDevice))
                return true;
            else {
                // Request USB permission
                PendingIntent pendingIntent = PendingIntent.getBroadcast(cxt.getApplicationContext(), 0, new Intent(ACTION_USB_PERMISSION), PendingIntent.FLAG_IMMUTABLE);
        ...
        @Override
        public void setGpioState(String pin, boolean high, Struct extra) {
        ...
        @Override
        public boolean getGpioState(String pin, Struct extra) {
        ...
        @Override
        public void setPwm(String pin, double dutyCyclePct, Struct extra) {
            pwmDuty.put(Integer.parseInt(pin), dutyCyclePct);
            startPwmLoop(Integer.parseInt(pin));
        }

        @Override
        public double getPwm(String pin, Struct extra) {
        ...
        @Override
        public void setPwmFrequency(String pin, int frequencyHz, Struct extra) {
            pwmFreq.put(Integer.parseInt(pin), frequencyHz);
            startPwmLoop(Integer.parseInt(pin));
        }

        @Override
        public int getPwmFrequency(String pin, Struct extra) {
        ...
        @Override
        public void writeAnalog(String pin, int value, Struct extra) {
            throw new MethodNotImplementedException("writeAnalog");
        }

        @Override
        public int getAnalogReaderValue(String pin, Struct extra) {
        ...
        @Override
        public int getDigitalInterruptValue(String digitalInterrupt, Struct extra) {
            throw new MethodNotImplementedException("getDigitalInterruptValue");
        }

        @Override
        public Iterator<com.viam.component.board.v1.Board.StreamTicksResponse> streamTicks(List<String> interrupts, Struct extra) {
            throw new MethodNotImplementedException("streamTicks");
        }

        @Override
        public void addCallbacks(List<String> interrupts, Queue<com.viam.component.board.v1.Board.StreamTicksResponse> tickQueue, Struct extra) {
            throw new MethodNotImplementedException("addCallbacks");
        }

        @Override
        public void setPowerMode(PowerMode powerMode, Duration duration, Struct extra) {
